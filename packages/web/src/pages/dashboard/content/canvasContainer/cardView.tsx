...
const CardView: FC<CardViewProps> = (props) => {
  ...
  return (
    ...
    >
      <div
        className="card-view flex h-full flex-col overflow-hidden rounded-md bg-white shadow-[0_1px_6px_rgba(15,23,42,0.08)]"
        onMouseDown={() => setCurrentEditingCardId(id)}
      >
