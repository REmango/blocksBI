...
import { IChartConfig, isWidgetComponentName } from '@block-bi/material'
...
const ChartConfig = () => {
  ...
  const styleConfig =
    currentCard?.componentName === 'chart' || isWidgetComponentName(currentCard?.componentName)
      ? currentCard.props.styleConfig
      : undefined
  ...
  return (
    <div className="chart-container chart-config-panel px-1 py-2">
      {!isWidgetComponentName(currentCard.componentName) && (
