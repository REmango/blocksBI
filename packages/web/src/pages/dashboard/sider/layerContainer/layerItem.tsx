...
import PaletteIcon from '../viewContainer/PaletteIcon'
import { hasPaletteIcon } from '../viewContainer/paletteIconMap'
...
const LayerItem = (props: LayerItemProps) => {
  ...
  return (
    ...
    >
      ...
      {iconKey && hasPaletteIcon(iconKey) ? (
        <PaletteIcon name={iconKey} size={14} className="text-orange-400" />
      ) : (
